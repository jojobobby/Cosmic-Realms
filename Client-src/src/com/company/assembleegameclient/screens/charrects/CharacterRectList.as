...
public class CharacterRectList extends Sprite {
    ...
    public function CharacterRectList() {
        ...
        for each (_local5 in _local4) {
            ...
            _local9 = new CurrentCharacterRect(_local2, _local7, _local5, _local8, this.model.getNumStars());

            /*if (Parameters.skinTypes80.indexOf(_local5.skinType()) != -1) {
                _local9.setIcon(this.getIcon(_local5, 10));
            }
            else if (Parameters.skinTypes64.indexOf(_local5.skinType()) != -1) {
                _local9.setIcon(this.getIcon(_local5, 15));
            }*/
            ...
            _local9.x = ((_local3 % 3) * (CharacterRect.WIDTH + 5));
            _local9.y = (int((_local3 / 3)) * (CharacterRect.HEIGHT + 4));
            addChild(_local9);
            _local3++;
        }
        if (this.model.hasAvailableCharSlot()) {
            _local10 = 0;
            while (_local10 < this.model.getAvailableCharSlots()) { //empty slot
                _local11 = new CreateNewCharacterRect(this.model);
                _local11.addEventListener(MouseEvent.MOUSE_DOWN, this.onNewChar);
                _local11.x = ((_local3 % 3) * (CharacterRect.WIDTH + 5));
                _local11.y = (int((_local3 / 3)) * (CharacterRect.HEIGHT + 4));
                addChild(_local11);
                _local3++;
                _local10++;
            }
        ...
        _local6.x = ((_local3 % 3) * (CharacterRect.WIDTH + 5));
        _local6.y = (int(_local3 / 3) * (CharacterRect.HEIGHT + 4));
        addChild(_local6);
    }
