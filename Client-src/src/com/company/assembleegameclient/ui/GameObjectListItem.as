    ...
    private function applyLongTextToBuilder():void {
        ...
        if (this.isNameDefined()) {
            ...
            if (this.showAccId) {
                charDesc += "{accountId}";
                //charDesc += "{fameAmount}";
                //make the whole panel a little bit bigger so the text can fot properly
            }
           ...
           // tokens.fameAmount = this.fameAmount ? "\n<b>Fame:</b> " + this.fameAmount : "";
        }
        else {
            charDesc = "<b>{name}</b>";
