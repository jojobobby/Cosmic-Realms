...
public class Slot extends Sprite {
    ...
    public static const ORB_TYPE:int = 21;//POWDER_TYPE
    ...
    private var graphicsData_:Vector.<IGraphicsData> = new <IGraphicsData>[this.fill_, this.path_, GraphicsUtil.END_FILL];
     */

    public function Slot(_arg1:int, _arg2:int, _arg3:Array) {
        this.fill_ = new GraphicsSolidFill(0x545454, 1); //Removed
        this.path_ = new GraphicsPath(new Vector.<int>(), new Vector.<Number>()); //Removed
        this.graphicsData_ = new <IGraphicsData>[this.fill_, this.path_, GraphicsUtil.END_FILL]; //Removed
        super();
        this.type_ = _arg1;
        this.hotkey_ = _arg2;
        this.cuts_ = _arg3;
    ...
    protected function drawBackground():void {
        ...
        switch (this.type_) {
            ...
            case PRISM_TYPE:
                ...
                break;
            case POWDER_TYPE:
                _local1 = AssetLibrary.getImageFromSet("lofiObj8",192);
                break;
            case SCEPTER_TYPE:
                _local1 = AssetLibrary.getImageFromSet("lofiObj6", 192);
                break;
            case HEALINGMAGIC_TYPE:
                _local1 = AssetLibrary.getImageFromSet("Crystal", 208);
                break;
        }
