...
public class StatusBar extends Sprite {
    ...
    public function draw(_arg1:int, _arg2:int, _arg3:int, _arg4:int = -1):void {
        ...
        this.boost_ = _arg3;
        this.maxMax_ = _arg4;
        this.toMax = this.maxMax_ - this.max_;
        this.internalDraw();
    }
    ...
    private function internalDraw():void {
     ...
     //   if ((((this.maxMax_ > 0)) && (((this.max_ - this.boost_) == this.maxMax_ + 50)))) {
      //      _local1 = 0xD5FBFC; // yellow
     //   }

        if ((((this.maxMax_ > 0)) && (((this.max_ - this.boost_) >= this.maxMax_)))) {
            _local1 = 0xFCDF00; // yellow
            if ((((this.maxMax_ > 0)) && (((this.max_ - this.boost_) == this.maxMax_ + 50)))) {
                _local1 = 0xD5FBFC; // yellow
            }
        }
    ...
    public function drawWithMouseOver():void {
        if(Parameters.data_.showLeftToMax && this.toMax > 0) {
            if (this.max_ > 0) {
                this.valueText_.setStringBuilder(this.valueTextStringBuilder_.setString(((this.val_ + "/") + this.max_+"|"+this.toMax)));
            }
            else {
