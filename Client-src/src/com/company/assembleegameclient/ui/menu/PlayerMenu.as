...
public class PlayerMenu extends Menu {
    ...
    public function init(_arg1:AGameSprite, _arg2:Player):void {
        ...
        if (!this.player_.ignored_) {
            _local3 = new MenuOption(AssetLibrary.getImageFromSet("lofiInterfaceBig", 8), 0xFFFFFF, TextKey.PLAYERMENU_IGNORE);
    ...
    private function onKickMultiBox(_arg1:Event):void {
        this.gs_.gsc_.playerText((("/ipban " + this.player_.name_) + " Multiboxing"));
        remove();
    }

    private function onKickRWT(_arg1:Event):void {
        this.gs_.gsc_.playerText((("/ipban " + this.player_.name_) + "RWT"));
        remove();
    }

    private function onKickCheat(_arg1:Event):void {
        this.gs_.gsc_.playerText((("/ipban " + this.player_.name_) + " Cheating"));
        remove();
    }
