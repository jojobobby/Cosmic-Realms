...
import ToolForge.ForgePlayerInventory;
...
public class ItemGridMediator extends Mediator {
    ...
    private function onTileMove(_arg1:ItemTileEvent):void {
        ...
        if ((_local3 is InteractiveItemTile)) {
            if (!this.isOnParent(_local3, ForgePlayerInventory)) {
            ...
            else
            {
                if ((((((((_local3 is FoodFeedFuseSlot)) || ((_local3 is ModalItemSlot)))) || ((_local3 is ForgeInventorySlot)))) || ((_local3 is ToolForgeFrame))))
                {
                    ...
                    {
                        if (_local3 is ForgeInventorySlot)
                        {
                            _local_9 = (_local3 as ForgeInventorySlot);
                            if (_local_9.setItem(_local2.getItemId(), _local2.tileId, _local2.ownerGrid.owner.objectId_, this.petFoodCancel(_local2)))
                            {
                                _local2.setItem(ItemConstants.NO_ITEM);
    ...
    private function isOnParent(_arg_1:*, _arg_2:Class):Boolean
    {
        while (_arg_1) {
            if ((_arg_1 is _arg_2)){
                return true;
