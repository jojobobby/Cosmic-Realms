    ...
    public function setType(_arg1:int):void {
        ...
        switch (_arg1) {
            ...
            case ItemConstants.KATANA_TYPE:
                ...
                break;
            case ItemConstants.POWDER_TYPE:
                _local2 = AssetLibrary.getImageFromSet("lofiObj8",192);
                break;
            case ItemConstants.HEALINGMAGIC_TYPE:
                _local2 = AssetLibrary.getImageFromSet("Crystal",208);
                break;
