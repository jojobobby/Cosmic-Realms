...
public class GameObjectArrow extends Sprite {
    ...
    public function correctQuestNote(rectangle:Rectangle):Rectangle
    {
        var rectangle1:Rectangle = rectangle.clone();
        ...
        rectangle1.right = rectangle1.right - (800 - this.go_.map_.gs_.hudView.x) * stage.stageWidth / Parameters.data_.mscale / 800;
        return rectangle1;
    }
    ...
    public function draw(_arg1:int, _arg2:Camera):void {
        ...
        _local3 = correctQuestNote(_arg2.clipRect_);
        _local4 = this.go_.posS_[0];
        _local5 = this.go_.posS_[1];
        if (!RectangleUtil.lineSegmentIntersectXY(_local3, 0, 0, _local4, _local5, this.tempPoint)) {
            this.go_ = null;
            visible = false;
            return;
        }
