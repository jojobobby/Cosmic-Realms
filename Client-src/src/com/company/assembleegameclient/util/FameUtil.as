...
import kabam.rotmg.chat.view.ChatListItemFactory_adminIcon;
...
public class FameUtil {
    ...
    private static const blackCT:ColorTransform = new ColorTransform(0, 0, 0);
    public static const COLORS:Vector.<ColorTransform> = new <ColorTransform>[lightBlueCT, darkBlueCT, redCT, orangeCT, yellowCT];
    public static const adminIcon:Class = ChatListItemFactory_adminIcon;
