...
public class AssetLoader {
    ...
    private function addImages():void {
        ...
        AssetLibrary.addImageSet("lofiObja",new EmbeddedAssets.lofiObjaEmbed_().bitmapData,8,8);
        AssetLibrary.addImageSet("lofiObjb",new EmbeddedAssets.lofiObjbEmbed_().bitmapData,8,8);
        ...
        AssetLibrary.addImageSet("Grounds0", new EmbeddedAssets.GroundsEmbed_().bitmapData, 8, 8);
        AssetLibrary.addImageSet("LRE", new EmbeddedAssets.LoERealmEquipmentsEmbed_().bitmapData, 8, 8);//GroundsEmbed_
        ...
        AssetLibrary.addImageSet("Moon", new EmbeddedAssets.MoonEmbed_().bitmapData, 8, 8);
        AssetLibrary.addImageSet("Crystal", new EmbeddedAssets.CrystalEmbed_().bitmapData, 8, 8);
        ...
        AssetLibrary.addImageSet("rain", new EmbeddedAssets.rainEmbed_().bitmapData, 5, 5);
        AssetLibrary.addImageSet("stars", new EmbeddedAssets.starsEmbed_().bitmapData, 5, 5);//ShipTilesEmbed_

        AssetLibrary.addImageSet("ShipTiles", new EmbeddedAssets.ShipTilesEmbed_().bitmapData, 8, 8);//16x16Objects
        AssetLibrary.addImageSet("16x16Objects", new EmbeddedAssets.T16x16ObjectsEmbed_().bitmapData, 16, 16);
        ...
        AssetLibrary.addImageSet("donorEmotes",new EmbeddedAssets.donorEmotesEmbed_().bitmapData,32,32);
        ...
        AssetLibrary.addImageSet("SilentWilderness16x16Objects", new EmbeddedAssets.SilentWilderness16x16ObjectsEmbed_().bitmapData,16,16);
        AssetLibrary.addImageSet("Duelist8x8", new EmbeddedAssets.Duelist8x8_().bitmapData,8,8);
        AssetLibrary.addImageSet("Duelist16x16", new EmbeddedAssets.Duelist16x16_().bitmapData,16,16);
        AssetLibrary.addImageSet("lofiparticlesMusicNotes", new EmbeddedAssets.lofiparticlesMusicNotesEmbed_().bitmapData,16,16);
    ...
    private function addAnimatedCharacters():void {
        ...
        AnimatedChars.add("SilentWilderness16x16Enemies", new EmbeddedAssets.SilentWilderness16x16EnemiesEmbed_().bitmapData, null,16,16,112,16,AnimatedChar.RIGHT)
    }
    ...
    private function parseObjectFiles():void {
        ...
        for each (_local_1 in EmbeddedData.objectFiles)
        {
            ...
            ObjectLibrary.parseFromXML(XML(_local_1), null, _local_1 is EmbeddedData.CustomDataCXML);
        }
