...
public class ProjectileProperties {
    ...
    public var vargoSpellBoomerang_:Boolean;
    public var blazingBoomerang_:Boolean;
    ...
    public function ProjectileProperties(_arg1:XML) {
        ...
        this.vargoSpellBoomerang_ = _arg1.hasOwnProperty("VargoSpellBoomerang");
        this.blazingBoomerang_ = _arg1.hasOwnProperty("BlazingBoomerang");
    }
