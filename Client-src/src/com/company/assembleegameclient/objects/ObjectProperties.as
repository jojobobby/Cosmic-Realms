...
public class ObjectProperties {
    ...
    public function ObjectProperties(_arg1:XML) {
        ...
        this.isChest_ = _arg1.hasOwnProperty("Chest");
        this.isQuest_ = _arg1.hasOwnProperty("Quest");
        this.isPlayer_ = _arg1.hasOwnProperty("Player");
        this.isEnemy_ = _arg1.hasOwnProperty("Enemy");
        this.isSpecialEnemy_ = _arg1.hasOwnProperty("SpecialEnemy");
        ...
        if (_arg1.hasOwnProperty("GlowColor")) {
            this.GlowColor_ = uint(_arg1.GlowColor);
        }
