package kabam.lib.util
{
    public class DateValidator
    {
        ...
        public function getDaysInMonth(givenMonth:int = -1, givenYear:int = -1):int
        {
            ...
            return givenMonth == FEBRUARY ? this.getDaysInFebruary(givenYear) : DAYS_IN_MONTH[(givenMonth - 1)];
        }
        ...
        {
            var isDivisibleBy4:* = givenYear % 4 == 0;
            var isDivisibleBy100:* = givenYear % 100 == 0;
            var isDivisibleBy400:* = givenYear % 400 == 0;
