...
public class EmbeddedAssets {
    ...
    public static var rainEmbed_:Class = EmbeddedAssets_rainEmbed_;
    public static var starsEmbed_:Class = EmbeddedAssets_starsEmbed_;//ShipTiles

    public static var ShipTilesEmbed_:Class = EmbeddedAssets_ShipTiles;
    public static var T16x16ObjectsEmbed_:Class = EmbeddedAssets_16x16Objects;
    ...
    public static var GroundsEmbed_:Class = EmbeddedAssets_Grounds;
    ...
    public static var lostHallsChars8x8:Class = EmbeddedAssets_lostHallsChars8x8Embed_;
    public static var lostHallsObjects16x16:Class = EmbeddedAssets_lostHallsObjects16x16;
    ...
    public static var CrystalEmbed_:Class = EmbeddedAssets_CrystalEmbed_;
    public static var MoonEmbed_:Class = EmbeddedAssets_MoonEmbed_;
    ...
    public static var lofiObj11Embed_:Class = EmbeddedAssets_lofiObj11Embed_;
    public static var lofiObj10Embed_:Class = EmbeddedAssets_lofiObj10Embed_;
    public static var lofiObjaEmbed_:Class = EmbeddedAssets_lofiObjaEmbed_;
    public static var lofiObjbEmbed_:Class = EmbeddedAssets_LofiObjbEmbed_;
    ...
    private static var FountainEmbed_:Class = EmbeddedAssets_FountainEmbed_;
    ...
    public static var SilentWildernessEmbed_:Class = EmbeddedAssets_SilentWildernessEmbed_;
    public static var SilentWilderness16x16ObjectsEmbed_:Class = EmbeddedAssets_SilentWilderness16x16ObjectsEmbed_;
    public static var SilentWilderness16x16EnemiesEmbed_:Class = EmbeddedAssets_SilentWilderness16x16EnemiesEmbed_;
    public static var lofiparticlesMusicNotesEmbed_:Class = EmbeddedAssets_lofiparticlesMusicNotesEmbed_;
    public static var e8080art:Class = EmbeddedAssets_e8080art;
    public static var e6464art:Class = EmbeddedAssets_e6464art;
    public static var Duelist8x8_:Class = EmbeddedAssets_Duelist8x8_;
    public static var Duelist16x16_:Class = EmbeddedAssets_Duelist16x16_;
    public static var lofiObj32x32:Class = EmbeddedAssets_lofiObj32x32_;
