...
public class StatData {
    ...
    public static const CRITICALDMG_STAT:int = 112;
    public static const CRITICALDMG_BOOST_STAT:int = 113;
    public static const CRITICALHIT_STAT:int = 114;
    public static const CRITICALHIT_BOOST_STAT:int = 115;
    public static const TOOLBELT:int = 116;
    public static const ENEMYRARITY:int = 117


    public static const BUMP = 106;
    ...
    public static function statToName(_arg1:int):String {
        switch (_arg1) {
            ...
            case CRITICALDMG_STAT:
                return (TextKey.STAT_MODEL_CRITICALDMG_LONG);
            case CRITICALHIT_STAT:
                return (TextKey.STAT_MODEL_CRITICALHIT_LONG);
            case LUCK:
