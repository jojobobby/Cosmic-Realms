...
public class Hello extends OutgoingMessage {
    ...
    public var rsa_:String;
    public var md5_:String;
    ...
    public function Hello(_arg1:uint, _arg2:Function) {
        ...
        this.rsa_ = new String();
        this.md5_ = new String();
        super(_arg1, _arg2);
    }
    ...
    override public function writeToOutput(_arg1:IDataOutput):void {
        ...
        _arg1.writeUTF(this.rsa_);
        _arg1.writeUTF(this.md5_);
    }

    override public function toString():String {
        return (formatToString("HELLO", "buildVersion_", "gameId_", "guid_", "password_", "secret_", "rsa_", "md5_"));
    }
