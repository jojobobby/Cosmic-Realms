...
public class GameServerConnection {
    ...
    public static const ACHIEVEMENT_UNLOCKED:int = 156;
    public static const FORGE_ITEM:int = 157;
    public static const CRITICALDAMAGE:int = 158;
    /* Market */
    public static const MARKET_SEARCH:int = 171;
    public static const MARKET_SEARCH_RESULT:int = 172;
    public static const MARKET_BUY:int = 173;
    public static const MARKET_BUY_RESULT:int = 174;
    public static const MARKET_ADD:int = 175;
    public static const MARKET_ADD_RESULT:int = 176;
    public static const MARKET_REMOVE:int = 177;
    public static const MARKET_REMOVE_RESULT:int = 178;
    public static const MARKET_MY_OFFERS:int = 179;
    public static const MARKET_MY_OFFERS_RESULT:int = 180;
    public static const FORGE_LIST = 181;
    public static const FORGE_LIST_RESULT = 182;
    public static const POTIONS = 184;
    public static const UPGRADE = 185;
    public static const WEATHERPROPERTIES:int = 186;
    ...
    public function forgeList(category:int):void {
    }

    public function marketSearch(byType:int, byRarity:int):void {
    ...
    public function marketAdd(slot:int, price:int) : void {
    }
    ...
    public function potions(_arg1:int, _arg2:Boolean):void {
    }

    public function upgrade(_arg1:Boolean, _arg2:Boolean, _arg3:Boolean):void {
    }
    ...
    public function forgeItem(param1:int, param2:int, param3:String, param4:Array, param5:Boolean, param6:String) : void
    {
    }
