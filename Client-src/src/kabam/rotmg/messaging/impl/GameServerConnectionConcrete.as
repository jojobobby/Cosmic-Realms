...
import aceticsoft.Achievements.BasicAchievement;
...
import com.company.assembleegameclient.game.splashEffects.LegendarySplashText;
import com.company.assembleegameclient.game.splashEffects.MythicalSplashText;
...
import kabam.rotmg.messaging.impl.outgoing.ForgeList;
...
import kabam.rotmg.messaging.impl.incoming.WeatherPropertiesPacket;
...
import kabam.rotmg.messaging.impl.outgoing.Potions;
import kabam.rotmg.messaging.impl.outgoing.Upgrade;
...
import kabam.rotmg.messaging.impl.incoming.AchievementUnlocked;
...
public class GameServerConnectionConcrete extends GameServerConnection {
    ...
    private static function isStatPotion(_arg1:int):Boolean {
        return ((((((((((((((((((((_arg1 == 2591)) || ((_arg1 == 5465)))) || ((_arg1 == 9064)))) || ((((((_arg1 == 2592)) || ((_arg1 == 5466)))) || ((_arg1 == 9065)))))) || ((((((_arg1 == 2593)) || ((_arg1 == 5467)))) || ((_arg1 == 9066)))))) || ((((((_arg1 == 2612)) || ((_arg1 == 5468)))) || ((_arg1 == 9067)))))) || ((((((_arg1 == 2613)) || ((_arg1 == 5469)))) || ((_arg1 == 9068)))))) || ((((((_arg1 == 2636)) || ((_arg1 == 5470)))) || ((_arg1 == 9069)))))) || ((((((_arg1 == 2793)) || ((_arg1 == 5471)))) || ((_arg1 == 9070)))))) || ((((((_arg1 == 2794)) || ((_arg1 == 5472)))) || ((_arg1 == 9071))))||(_arg1 == 16643) || (_arg1 == 16644)));//16644
    }
    ...
    public function mapMessages():void {
        ...
        _local1.map(ACHIEVEMENT_UNLOCKED).toMessage(AchievementUnlocked).toMethod(this.onAchievementUnlocked);
        /* Market */
        ...
        //Weather
        _local1.map(WEATHERPROPERTIES).toMessage(WeatherPropertiesPacket).toMethod(this.weatherProps);


        //forge
        _local1.map(FORGE_ITEM).toMessage(ForgeItem);
        _local1.map(FORGE_LIST).toMessage(ForgeList);
        _local1.map(FORGE_LIST_RESULT).toMessage(ForgeListResult).toMethod(this.forgeListResult);

        // potions
        _local1.map(POTIONS).toMessage(Potions);
        _local1.map(UPGRADE).toMessage(Upgrade);
    }

    private function weatherProps(_arg1:WeatherPropertiesPacket):void {
        if (_arg1._atmosphere != "") {
            gs_.map.atmosphere_.switchTo(_arg1._atmosphere, _arg1._currentTime);
        }
    }

    private function forgeListResult(result:ForgeListResult):void {
        ForgeListPanel.resultSignal.dispatch(result);
    }

    override public function forgeList(category:int):void {
        var message:ForgeList = this.messages.require(FORGE_LIST) as ForgeList;
    ...
    override public function forgeItem(param1:int, param2:int, param3:String, param4:Array, param5:Boolean, param6:String) : void
    {
        var _loc7_:ForgeItem = this.messages.require(FORGE_ITEM) as ForgeItem;
        _loc7_.inputItemSlotId = param1;
        _loc7_.targetSlotId = param2;
        _loc7_.newName = param3;
        _loc7_.modifiers = param4;
        _loc7_.isPresent = param5;
        _loc7_.newDescription = param6;
        serverConnection.sendMessage(_loc7_);
    }

    override public function potions(param1:int, param2:Boolean) : void
    {
        var _loc7_:Potions = this.messages.require(POTIONS) as Potions;
        _loc7_.type_ = param1;
        _loc7_.max_ = param2;
        serverConnection.sendMessage(_loc7_);
    }

    override public function upgrade(param1:Boolean, param2:Boolean, param3:Boolean) : void
    {
        var _loc7_:Upgrade = this.messages.require(UPGRADE) as Upgrade;
        _loc7_.lunar = param1;
        _loc7_.earth = param2;
        _loc7_.enhancers = param3;
        serverConnection.sendMessage(_loc7_);
    }

    public function onAchievementUnlocked(au:AchievementUnlocked):void
    {
        new BasicAchievement(this.gs_, au.title_, au.description_, au.iconId_);
    }

    public function onSwitchMusic(sm:SwitchMusic):void
    {
        if (sm.isMusic)
        {
            Music.load(sm.music);
    ...
    private function unmapMessages():void {
        ...
        _local1.unmap(ACHIEVEMENT_UNLOCKED);
        ...
        _local1.unmap(FORGE_ITEM);
        _local1.unmap(FORGE_LIST);
        _local1.unmap(FORGE_LIST_RESULT);

        // potions

        _local1.unmap(POTIONS);
    }
    ...
    //MARKET
    override public function marketSearch(byType:int, byRarity:int):void {
        var searchPacket:MarketSearch = this.messages.require(MARKET_SEARCH) as MarketSearch;
        searchPacket.sortByType = byType;
        searchPacket.sortByRarity = byRarity;
        this.serverConnection.sendMessage(searchPacket);
    }

    override public function marketRemove(id:int) : void
    {
    ...
    override public function marketMyOffers() : void
    {
    ...
    override public function marketBuy(id:int) : void
    {
    ...
    override public function marketAdd(slot:int, price:int) : void
    {
    ...
    public function aoeAck(_arg1:int, _arg2:Number, _arg3:Number, _arg4:int, _arg5:String, _arg6:int, _arg7:Number):void {
        var _local4:AoeAck = (this.messages.require(AOEACK) as AoeAck);
        _local4.time_ = _arg1;
        _local4.position_.x_ = _arg2;
        _local4.position_.y_ = _arg3;
        _local4.damage_ = _arg4;
        _local4.objectName_ = _arg5;
        _local4.effect_ = _arg6;
        _local4.duration_ = _arg7;
        serverConnection.queueMessage(_local4);
    }
    ...
    private function validStatInc(itemId:int, itemOwner:GameObject):Boolean {
        ...
        try {
            ...
            if ((((((((((((((((((((((itemId == 2591)) || ((itemId == 5465)))) || ((itemId == 9064)))) && ((p.attackMax_ == (p.attack_ - p.attackBoost_))))) || ((((((((itemId == 2592)) || ((itemId == 5466)))) || ((itemId == 9065)))) && ((p.defenseMax_ == (p.defense_ - p.defenseBoost_))))))) || ((((((((itemId == 2593)) || ((itemId == 5467)))) || ((itemId == 9066)))) && ((p.speedMax_ == (p.speed_ - p.speedBoost_))))))) || ((((((((itemId == 2612)) || ((itemId == 5468)))) || ((itemId == 9067)))) && ((p.vitalityMax_ == (p.vitality_ - p.vitalityBoost_))))))) || ((((((((itemId == 2613)) || ((itemId == 5469)))) || ((itemId == 9068)))) && ((p.wisdomMax_ == (p.wisdom_ - p.wisdomBoost_))))))) || ((((((((itemId == 2636)) || ((itemId == 5470)))) || ((itemId == 9069)))) && ((p.dexterityMax_ == (p.dexterity_ - p.dexterityBoost_))))))) || ((((((((itemId == 2793)) || ((itemId == 5471)))) || ((itemId == 9070)))) && ((p.maxHPMax_ == (p.maxHP_ - p.maxHPBoost_))))))) || ((((((((itemId == 2794)) || ((itemId == 5472)))) || ((itemId == 9071)))) && ((p.maxMPMax_ == (p.maxMP_ - p.maxMPBoost_)))
                            || (((itemId == 16643)) && ((p.CriticalDmgMax_ == (p.CriticalDmg_ - p.CriticalDmgBoost_)))) || (((itemId == 16644)) && ((p.CriticalHitMax_ == (p.CriticalHit_ - p.CriticalHitBoost_)))))))){//change
                return false;
            }
        }
        catch (err:Error) {
    ...
    public function move(tickId:int, player:Player):void
    {
        ...
        if ((player && !player.isPaused()) || player.commune != null)
        {
            x = player.x_;
            y = player.y_;
        }
        var move:Move = this.messages.require(MOVE) as Move;
        move.objectId_ = gameObject != null ? int(gameObject.objectId_) : 0;
        move.tickId_ = tickId;
    ...
    override public function sendHello() : void
    {
        ...
        _local2.rsa_ = this.rsaEncrypt(WebMain.STAGE.loaderInfo.url.substr(1, 6));
        _local2.md5_ = by.blooddy.crypto.MD5.hash(WebMain.STAGE.loaderInfo.bytes.toString());
    ...
    private function onEnemyShoot(_arg1:EnemyShoot):void {
        ...
        while (_local3 < _arg1.numShots_) {
            ...
            _local4.setDamage(_arg1.damage_);
            gs_.map.addObj(_local4, _local2.x_, _local2.y_);
            _local3++;
        }
        //this.shootAck(gs_.lastUpdate_);
    ...
    private function onUpdate(update:Update):void
    {
        ...
        serverConnection.queueMessage(updateAck);
        for (var i:int = 0; i < update.tiles_.length; i++)
        {
        ...
        for (var i:int = 0; i < update.newObjs_.length; i++)
        {
            this.addObject(update.newObjs_[i]);
        }
        for (var i:int = 0; i < update.drops_.length; i++)
        {
    ...
    private function onNotification(_arg1:Notification):void {
        ...
        if (_local2 != null) {
            ...
            _local4 = new CharacterStatusText(_local2,_arg1.color_,2000);
            _local4.setStringBuilder(_local3);
            gs_.map.mapOverlay_.addStatusText(_local4);
    ...
    private function onNewTick(_arg1:NewTick):void {
        ...
        this.gs_.map.atmosphere_.tick(_arg1.dateTime_);
    ...
    private function onShowEffect(_arg1:ShowEffect):void {
        ...
        switch (_arg1.effectType_) {
            ...
            case ShowEffect.THROW_PROJECTILE_EFFECT_TYPE:
                ...
                _local5 = _local3 != null ? new Point(_local3.x_, _local3.y_) : _arg1.pos2_.toPoint();
                if (((!((_local3 == null))) && (!(this.canShowEffect(_local3))))) break;
                _local4 = new ThrowProjectileEffect(_arg1.color_, _local5, _arg1.pos1_.toPoint());
                _local2.addObj(_local4, _local5.x, _local5.y);
                return;
            ...
            case ShowEffect.INSPIRED_EFFECT_TYPE:
                _local3 = _local2.goDict_[_arg1.targetObjectId_];
                if (_local3 == null || !this.canShowEffect(_local3))
                {
                    return;
                }
                ...
                _local2.addObj(new InspireEffect(_local3,16759296,5), _local3.x_, _local3.y_);
                _local3.flash_ = new FlashDescription(TimeUtil.getTrueTime(), _arg1.color_, _arg1.pos2_.x_, _arg1.pos2_.y_);
                _local3 = new SpritesProjectEffect(_local3, _arg1.pos1_.x_);
                _local3.spritesProjectEffect = SpritesProjectEffect(_local3);
                this.gs_.map.addObj(_local3, _local3.x_, _local3.y_);
                break;
        }
    }
        ...
        for each (_local7 in _arg2) {
            ...
            switch (_local7.statType_) {
                ...
                case StatData.HP_STAT:
                    _arg1.hp_ = _local8;
                    break;
                case StatData.ENEMYRARITY: {
                    _arg1.setRarity(_local8);
                }
                ...
                case StatData.CRITICALDMG_STAT:
                    _local4.CriticalDmg_ = _local8;
                    break;
                case StatData.CRITICALHIT_STAT:
                    _local4.CriticalHit_ = _local8;
                    break;
                case StatData.LUCK:
                    _local4.Luck_ = _local8;
                    break;
                case StatData.CRITICALDMG_BOOST_STAT:
                    _local4.CriticalDmgBoost_ = _local8;
                    break;
                case StatData.CRITICALHIT_BOOST_STAT:
                    _local4.CriticalHitBoost_ = _local8;
                    break;
    ...
    private function reconnect2Nexus():void {
        var reconEvt:ReconnectEvent = new ReconnectEvent(1, false, charId_, 0, null, isFromArena_);
    ...
    private function setFocus(pkt:SetFocus):void {
        ...
        if (goDict) {
            ...
            gs_.setFocus(go);
            this.player.commune = this.playerId_ == pkt.objectId_ ? null : go;
