...
public class StatView extends Sprite {
    ...
    public function draw(_arg1:int, _arg2:int, _arg3:int, lefToMax:int = 0):void {
        var _local4:uint;
        ...
        if(lefToMax > 0 && Parameters.data_.showLeftToMax){
            _local5 = _local5 + "|"+ lefToMax.toString();
        }
        if (this.boost_ != 0) {
