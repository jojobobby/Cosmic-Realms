...
public class StatsView extends Sprite {
    ...
    public static const CRITICALDMG:int = 6;
    public static const CRITICALHIT:int = 7;
    public static const LUCK:int = 8;
    ...
    private function drawStats(_arg1:Player):void {
        this.stats_[ATTACK].draw(_arg1.attack_, _arg1.attackBoost_, _arg1.attackMax_, _arg1.attackMax_ - _arg1.attack_ + _arg1.attackBoost_);
        this.stats_[DEFENSE].draw(_arg1.defense_, _arg1.defenseBoost_, _arg1.defenseMax_, _arg1.defenseMax_ - _arg1.defense_ + _arg1.defenseBoost_);
        this.stats_[SPEED].draw(_arg1.speed_, _arg1.speedBoost_, _arg1.speedMax_, _arg1.speedMax_ - _arg1.speed_+ _arg1.speedBoost_);
        this.stats_[DEXTERITY].draw(_arg1.dexterity_, _arg1.dexterityBoost_, _arg1.dexterityMax_, _arg1.dexterityMax_ - _arg1.dexterity_+ _arg1.dexterityBoost_);
        this.stats_[VITALITY].draw(_arg1.vitality_, _arg1.vitalityBoost_, _arg1.vitalityMax_, _arg1.vitalityMax_ - _arg1.vitality_+ _arg1.vitalityBoost_);
        this.stats_[WISDOM].draw(_arg1.wisdom_, _arg1.wisdomBoost_, _arg1.wisdomMax_, _arg1.wisdomMax_ - _arg1.wisdom_+ _arg1.wisdomBoost_);
        this.stats_[CRITICALDMG].draw(_arg1.CriticalDmg_, _arg1.CriticalDmgBoost_, _arg1.CriticalDmgMax_, _arg1.CriticalDmgMax_ - _arg1.CriticalDmg_ + _arg1.CriticalDmgBoost_);
        this.stats_[CRITICALHIT].draw(_arg1.CriticalHit_, _arg1.CriticalHitBoost_, _arg1.CriticalHitMax_, _arg1.CriticalHitMax_ - _arg1.CriticalHit_ + _arg1.CriticalHitBoost_);
        this.stats_[LUCK].draw(_arg1.Luck_, _arg1.LuckBoost_, _arg1.LuckMax_, _arg1.LuckMax_ - _arg1.Luck_ + _arg1.LuckBoost_);
    }
    ...
    private function createBackground():Sprite {
        ...
        this.background.graphics.beginFill(0x33FAFF);
        this.background.graphics.lineStyle(2, 0xFFFFFF);
        this.background.graphics.drawRoundRect(-5, -5, (this.WIDTH + 10), (this.HEIGHT + 36), 10);
