...
public class TabStripMediator extends Mediator {
    ...
    private function addTabs(_arg1:Player):void {
        ...
        this.view.addTab(this.iconFactory.makeIconBitmap2(8, "lofiObj"), new InventoryTabContent(_arg1));
        if (this.doShowStats) {
           // this.view.addTab(this.iconFactory.makeIconBitmap(TabConstants.STATS_ICON_ID), new StatsTabContent(this.view.HEIGHT));
            this.view.addTab(this.iconFactory.makeIconBitmapFromPotions(), new StatsTabContent(this.view.HEIGHT));
        }
        if (_arg1.hasBackpack_) {
            ...
            this.view.addTab(this.iconFactory.makeIconBitmap2(789, "lofiObj3"), new BackpackTabContent(_arg1));
        }
        else {
    ...
    private function onUpdateBackPack(_arg1:Boolean):void {
        ...
        if (_arg1) {
            ...
            this.view.addTab(this.iconFactory.makeIconBitmap2(789, "lofiObj3"), new BackpackTabContent(_local2));
            this.updateBackpack.remove(this.onUpdateBackPack);
        }
    }
