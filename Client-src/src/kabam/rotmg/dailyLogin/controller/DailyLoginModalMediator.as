...
public class DailyLoginModalMediator extends Mediator {
    ...
    override public function initialize():void {
        ...
        _local3.time--;
        this.view.showLegend((this.hudModel.gameSprite.map.name_ == Map.VAULT));
        this.view.showServerTime(_local1.format(this.dailyLoginModel.getServerTime()), _local1.format(_local3));
        if (this.hudModel.gameSprite.map.name_ != Map.VAULT) {
    ...
    private function enterPortal():void {
        ...
        this.hudModel.gameSprite.gsc_.playerText("/vault");
    }
