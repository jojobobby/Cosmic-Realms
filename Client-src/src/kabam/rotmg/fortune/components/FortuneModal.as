...
public class FortuneModal extends EmptyFrame {
    ...
    public static function doEaseOutInAnimation(_arg1:DisplayObject, _arg2:Object = null, _arg3:Object = null, _arg4:Function = null):void {
        var _local5:GTween = new GTween(_arg1, (0.5), _arg2, {"ease": Sine.easeOut});
        _local5.nextTween = new GTween(_arg1, (0.5), _arg3, {"ease": Sine.easeIn});
    ...
    private function resetBalls():void {
        ...
        while (_local2 < 3) {
            ...
            if (this.crystals[_local2].parent == null) {
                ...
                if (!this.crystals[_local2].visible) {
