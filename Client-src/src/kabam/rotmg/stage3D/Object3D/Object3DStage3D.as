...
public class Object3DStage3D {
    ...
    public function draw(_arg1:Context3D):void {
        ...
        _arg1.setVertexBufferAt(0, this.model_.vertexBuffer, 0, "float3");
        _arg1.setVertexBufferAt(1, this.model_.vertexBuffer, 3, "float3");
        _arg1.setVertexBufferAt(2, this.model_.vertexBuffer, 6, "float2");
        if ((((this.texture_ == null)) && (!((this.bitmapData == null))))) {
            this.texture_ = _arg1.createTexture(this.bitmapData.width, this.bitmapData.height, "bgra", false);
