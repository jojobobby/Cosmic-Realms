    ...
    override public function draw():void {
        ...
        for each (_local10 in map.goDict_) {
            ...
            if (!((_local10.props_.noMiniMap_) || ((_local10 == this.focus)))) {
                ...
                if (_local16 != null) {
                    if (_local16.commune == null) {
                        if (_local16.isPaused() && map.player_.commune == null) {
                            _local15 = 0x7F7F7F;
                        } else {
                ...
                }// go =  _local10 | fillcolor -= _local15
                else {
                    if ((_local10 is Character)) {
                        if(_local10.props_.isSpecialEnemy_)
                        {
                            if(_local10.objectType_ == 0x0935)//0x0935
                                _local15 = 0xb5e8e4;
                            else if(_local10.objectType_ == 0x6006)
                                _local15 = 0xedd68a;
                            else if(_local10.objectType_ == 0x6db)
                                _local15 = 0x622edb;
                            else if(_local10.objectType_ == 0x099a)
                                _local15 = 0x852edb;//0x099a 0x734d 0x738c
                            else if(_local10.objectType_ == 0x734d)
                                _local15 = 0xdad1e3;
                            else if(_local10.objectType_ == 0x738c)
                                _local15 = 0xff29c9;
                        }
                        else if (_local10.props_.isEnemy_) {
                            _local15 = 0xFF0000;
                        }
                        else {
