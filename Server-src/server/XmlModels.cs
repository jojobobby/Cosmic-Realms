...
namespace server
{
    ...
    class Vault
    {
        ...
        public static Vault FromDb(DbAccount acc, DbVault vault)
        {
            return new Vault()
            {
                chests = Enumerable.Range(0, acc.VaultCount).
    ...
    class Character
    {
        ...
        public int CriticalDmg { get; private set; }
        ...
        public static Character FromDb(DbChar character, bool dead)
        {
            return new Character()
            {
                ...
                CriticalDmg = character.Stats[11],
                CriticalHit = character.Stats[12],
        ...
        public XElement ToXml()
        {
            return
                new XElement("Char",
                    ...
                    new XElement("CriticalDmg", CriticalDmg),
                    new XElement("CriticalHit", CriticalHit),
