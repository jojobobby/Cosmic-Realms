...
namespace wServer.logic.behaviors
{
    internal class Orbit : CycleBehavior
    {
        ...
        private readonly ushort? target;//orbitClockwise
        private readonly bool orbitClockwise;
        public Orbit(double speed, double radius, double acquireRange = 10,
            string target = null, double? speedVariance = null, double? radiusVariance = null, bool orbitClockwise = false)
        {
