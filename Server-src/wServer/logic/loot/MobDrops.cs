...
namespace wServer.logic.loot
{
        ...
        public virtual void Populate(IList<LootDef> lootDefs, LootDef overrides = null)
        {
            ...
            foreach (var lootDef in LootDefs)
            {
                lootDefs.Add(new LootDef(
                    ...
                    overrides.Damagebased != false ? overrides.Damagebased : lootDef.Damagebased));
            }
        }
    }
    ...
    public class ItemLoot : MobDrops
    {
        ...
        public ItemLoot(string item, double probability = 1, int numRequired = 0, double threshold = 0, bool damagebased = false)
        {
            try
            {
                LootDefs.Add(new LootDef(
    ...
    public class TierLoot : MobDrops
    {
        ...
        private static readonly int[] AbilityT = new int[] { 4, 5, 11, 12, 13, 15, 16, 18, 19, 20, 21, 22, 23, 25, 54, };
