    ...
    partial class BehaviorDb
    {
        private _ Highlands = () => Behav()
            ...
            .Init("Undead Dwarf Warrior",
                new State(
                    new DropPortalOnDeath("Spider Den Portal", 0.03),
                    new Shoot(3),
                    new Prioritize(
                        new StayAbove(1, 160),
            ...
            .Init("iiBeer God",
                ...
                new Threshold(0.01,
                    ...
                    new ItemLoot("Realm-wheat Hefeweizen", 0.4),
                    new ItemLoot("Mad God Ale", 0.4),
                    new ItemLoot("Oryx Stout", 0.4)
                    )
            )
            //High Sand
            .Init("Flayer God",
