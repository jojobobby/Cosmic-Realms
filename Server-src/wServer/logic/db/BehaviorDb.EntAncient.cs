    ...
    partial class BehaviorDb
    {
        private _ EntAncient = () => Behav()
            .Init("Ent Ancient",
                new State(
                    ...
                    new State("SmallGroup",
                        ...
                        new TossObject("Ent", range: 3, angle: 0, coolDown: 100000, throwEffect: true),
                        new TossObject("Ent", range: 4.5, angle: 180, coolDown: 100000, throwEffect: true),
            ...
            .Init("Actual Ent Ancient",
                new State(
                    new DropPortalOnDeath("Belladonna's Garden Portal", 0.50),
                    new Prioritize(
                ...
                new Threshold(.001,
                    new ItemLoot("Plate of Mother Nature", 0.05),
            ...
            .Init("Greater Nature Sprite",
                new State(
                    ...
                    new State("Idle",
                        new TimedTransition(20000, "Transform")
                        ),
                    new State("Transform",
