        ...
        private _ RedDemon = () => Behav()
            .Init("Red Demon",
                ...
                new Threshold(.00001,
                    ...
                    new ItemLoot("Potion of Critical Chance", 0.05),
                    new ItemLoot("Potion of Critical Damage", 0.05),
                    new ItemLoot("Shard of Fire", 0.01, threshold: 0.01, damagebased: true),//Quiver of Lava
                    new ItemLoot("Quiver of Lava", 0.008, damagebased: true),
