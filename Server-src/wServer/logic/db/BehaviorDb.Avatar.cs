        ...
        private _ Avatar = () => Behav()
            .Init("shtrs Defense System", //Avatar of the Forgotten King 
                new State(
                    ...
                    new State("Phase2", //Eye
                        ...
                        new State("Spawn",
                            ...
                            new TimedTransition(100000, "Respawn")
                            ),
                        new State("Respawn",
                            new Spawn("shtrs eyeswarmer", 6, 1, coolDown: 14000),
                            new TimedTransition(100000, "Spawn")
                            )
                        ),
                    new State("Phase3.0",
                        new SetAltTexture(0),
                    ...
                    new State("Phase4",
                     new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        ...
                        new TimedTransition(1000, "Waitbrofuckman")
                            ),
                    new State("Waitbrofuckman",
                      new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new EntitiesNotExistsTransition(10, "Final", "shtrs Pillar 4", "shtrs Pillar 1", "shtrs Pillar 2", "shtrs Pillar 3")
                        ),
                    new State("Waiting4",
                      new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                ...
                new Threshold(0.0001,
                    ...
                    new TierLoot(10, ItemType.Armor, 0.0625),
                    ...
                    new ItemLoot("Tablet of the King's Avatar", 0.006, damagebased: true),
                    new ItemLoot("Shattered Scythe", 0.004, damagebased: true),
                    new ItemLoot("Awoken Shattered Scythe", 0.002, damagebased: true, threshold: 0.01),
                    new ItemLoot("Avatar's Skull", 0.001, damagebased: true, threshold: 0.01),
                    new ItemLoot("Staff of the Dire Omen", 0.006, damagebased: true)
                    )
            )
