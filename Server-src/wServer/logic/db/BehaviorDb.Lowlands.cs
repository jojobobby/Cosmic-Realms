...
//by Creepylava, GhostMaree
namespace wServer.logic
{
    partial class BehaviorDb
    {
        private _ Lowlands = () => Behav()
            //Low Plains
            .Init("Hobbit Mage",
                new State(
                ...
                new Threshold(0.01,
                    ...
                    new TierLoot(1, ItemType.Armor, 0.3),
            ...
            .Init("Goblin Warrior",
                new State(
                    new DropPortalOnDeath("Pirate Cave Portal", 0.03),
                    new Shoot(3),
                    new State("protect",
                        new Protect(0.8, "Goblin Mage", acquireRange: 12, protectionRange: 1.5, reprotectRange: 1.5),
                        new TimedTransition(1200, "scatter", randomized: true)
            ...
            .Init("Giant Crab",
                ...
                new Threshold(0.01,
                    ...
                    new TierLoot(1, ItemType.Armor, 0.19),
