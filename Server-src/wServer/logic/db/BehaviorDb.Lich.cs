        ...
        private _ Lich = () => Behav()
            .Init("Lich",
                new State(
                    ...
                    new State("HugeMob",
                        ...
                        new TossObject("Phylactery Bearer", range: 5.5, angle: 0, coolDown: 100000, throwEffect: true),
                        new TossObject("Phylactery Bearer", range: 5.5, angle: 120, coolDown: 100000, throwEffect: true),
                        new TossObject("Phylactery Bearer", range: 5.5, angle: 240, coolDown: 100000, throwEffect: true),
                        new TossObject("Phylactery Bearer", range: 3, angle: 60, coolDown: 100000, throwEffect: true),
                        new TossObject("Phylactery Bearer", range: 3, angle: 180, coolDown: 100000, throwEffect: true),
                        new Prioritize(
            ...
            .Init("Phylactery Bearer",
                new State(
                    ...
                    new Threshold(0.01,
                        new ItemLoot("Magic Potion", 0.4),
                        new ItemLoot("Soulless Robe", 0.02),
                        new ItemLoot("Ring of the Covetous Heart", 0.02),
                        new ItemLoot("Soul of the Bearer", 0.02),
                        new ItemLoot("The Phylactery", 0.02),
                        new ItemLoot("Mini Phylactery Skin", 0.02)
                    )
            )
            .Init("Haunted Spirit",
                new State(
