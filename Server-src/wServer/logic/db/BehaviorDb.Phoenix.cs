...
namespace wServer.logic
{
    partial class BehaviorDb
    {
        private _ Phoenix = () => Behav()
            .Init("Phoenix Lord",
                new State(
                    new ScaleHP(200, 1000, false, 20, 2),
            ...
            .Init("Phoenix Reborn",
                ...
                new Threshold(0.001,
                new ItemLoot("Bow of Reanimation", 0.006, damagebased: true),
                new ItemLoot("Quiver of Reanimation", 0.006, damagebased: true),
                new ItemLoot("Hide of Reanimation", 0.006, damagebased: true),
                new ItemLoot("Amulet of Reanimation", 0.006, damagebased: true),
