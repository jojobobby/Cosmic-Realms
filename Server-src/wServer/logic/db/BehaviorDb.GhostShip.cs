        ...
        private _ GhostShip = () => Behav()
            .Init("Ghost Ship",
                new State(
                   new ScaleHP2(85, 2, 15),
                    ...
                    new State("Phase1+2",
                        ...
                        new TossObject("Water Mine", angle: 1, coolDown: 5000, minRange: 3, maxRange: 7, minAngle: 1, maxAngle: 359, throwEffect: true),
                        new State("Attack",
                            new Prioritize(
                                new Follow(0.2, 10, 3),
                                new Wander(0.3),
                    ...
                    new State("PrePhase5",
                        new TossObject("Tempest Cloud", 8, 0, tossInvis: true, coolDown: 10000, throwEffect: true),
                        new TossObject("Tempest Cloud", 8, 36, tossInvis: true, coolDown: 10000, throwEffect: true),
                        new TossObject("Tempest Cloud", 8, 72, tossInvis: true, coolDown: 10000, throwEffect: true),
                        new TossObject("Tempest Cloud", 8, 108, tossInvis: true, coolDown: 10000, throwEffect: true),
                        new TossObject("Tempest Cloud", 8, 144, tossInvis: true, coolDown: 10000, throwEffect: true),
                        new TossObject("Tempest Cloud", 8, 180, tossInvis: true, coolDown: 10000, throwEffect: true),
                        new TossObject("Tempest Cloud", 8, 216, tossInvis: true, coolDown: 10000, throwEffect: true),
                        new TossObject("Tempest Cloud", 8, 252, tossInvis: true, coolDown: 10000, throwEffect: true),
                        new TossObject("Tempest Cloud", 8, 288, tossInvis: true, coolDown: 10000, throwEffect: true),
                        new TossObject("Tempest Cloud", 8, 324, tossInvis: true, coolDown: 10000, throwEffect: true),
                ...
                new Threshold(0.0001,
                    new ItemLoot("Ghost Pirate Rum", .4),
                    new ItemLoot("Ghost Pirate Rum", .3),
                    new ItemLoot("Ghost Pirate Rum", .2),
                    new ItemLoot("Ghost Pirate Rum", .1),
                    new ItemLoot("Potion of Wisdom", .3, 3),
                    new ItemLoot("Potion of Wisdom", .8),
                    new ItemLoot("Potion of Defense", .7),
                    new ItemLoot("Potion of Speed", .7),
                    new ItemLoot("Potion of Critical Chance", 0.02),
                    new ItemLoot("Potion of Critical Damage", 0.02),
                    new ItemLoot("Seaweed Poison Grenade", 0.006, damagebased: true),
                    new ItemLoot("whirlpool trap", 0.001, damagebased: true, threshold: 0.01),
