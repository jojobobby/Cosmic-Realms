...
namespace wServer.logic
{
    ...
    {
        private _ MysteriousCrystal = () => Behav()
            .Init("Mysterious Crystal",
                new State(
                    ...
                    new State("Evaluation",
                        ...
                        new HpLessTransition(0.98, "StartBreak"),
            ...
            .Init("Crystal Prisoner",
                ...
                //Deadwater Docks
                new DropPortalOnDeath("Deadwater Docks"),
                ...
                new Threshold(0.00001,
                    new TierLoot(2, ItemType.Potion, probability: 0.3, numRequired: 3),
                    new ItemLoot("Potion of Attack", 1.05),
                    new ItemLoot("Potion of Speed", 0.50),
                    new ItemLoot("Potion of Defense", 1.05),//Armor of Pierced Crystals
                    new ItemLoot("Potion of Critical Chance", 0.02),
                    new ItemLoot("Potion of Critical Damage", 0.02),
                    new ItemLoot("Crystal Wand", 0.006, damagebased: true),
                    new ItemLoot("Armor of Pierced Crystals", 0.004, damagebased: true),
                    new ItemLoot("Crystal Wakizashi", 0.006, damagebased: true),
                    new ItemLoot("Crystal Sword", 0.006, damagebased: true)
                    )
            )
