...
namespace wServer.realm.setpieces
{
    partial class SetPieces
    {
        ...
        static readonly List<Tuple<ISetPiece, int, int, WmapTerrain[]>> setPieces = new List<Tuple<ISetPiece, int, int, WmapTerrain[]>>()
        {
            ...
            SetPiece(new CandyGnome(), 5, 10, WmapTerrain.HighForest, WmapTerrain.HighPlains),
            ...
            SetPiece(new HolyCross(), 7, 10, WmapTerrain.LowSand, WmapTerrain.MidSand),
            ...
            SetPiece(new RedDemon(), 3, 5, WmapTerrain.Mountains),

            SetPiece(new KageKami(), 10, 12, WmapTerrain.HighForest, WmapTerrain.HighPlains),
            SetPiece(new Skuld(), 10, 12, WmapTerrain.HighForest, WmapTerrain.HighPlains),
            SetPiece(new GiantOryxChicken(), 1, 1, WmapTerrain.Mountains),
            SetPiece(new FERAL(), 10, 12, WmapTerrain.Mountains),

            SetPiece(new Beroth(), 5, 10, WmapTerrain.MidForest, WmapTerrain.MidPlains),

            //once per realm "<SpecialEnemy/>"
            SetPiece(new Avatar(), 1, 1, WmapTerrain.Mountains),
            SetPiece(new MysteriousCrystal(), 3, 5, WmapTerrain.Mountains),
            SetPiece(new LostSentry(), 1, 2, WmapTerrain.HighForest, WmapTerrain.HighPlains),

            //secretevents
            SetPiece(new Belladonna(), 3, 5, WmapTerrain.Mountains, WmapTerrain.HighPlains)
        };
