...
namespace wServer.realm
{
    ...
    class Oryx
    {
        ...
        private readonly List<Tuple<string, ISetPiece>> _events = new List<Tuple<string, ISetPiece>>()
        {
            ...
            Tuple.Create("Pentaract Tower", (ISetPiece) new PentaractTowerUltra()),
            ...
            Tuple.Create("Permafrost Lord", (ISetPiece) new PermafrostLord()),
            Tuple.Create("Alien U.F.O", (ISetPiece) new MShip()),
            //Tuple.Create("md Janus the Doorwarden", (ISetPiece) new JanustheDoorwarden()), Dragon Head
            Tuple.Create("King Toadstool", (ISetPiece) new Toad()),
            Tuple.Create("Raijin, the Lightning Guardian", (ISetPiece) new Raijin()),
            Tuple.Create("Primaeval The Ancient Totem", (ISetPiece) new Primaeval()),
            Tuple.Create("Bloody Tissue", (ISetPiece) new BloodyTissue()),
            Tuple.Create("Spectre's Guardian", (ISetPiece) new SpectreEvent()),
            Tuple.Create("Krystaline", (ISetPiece) new Krystal()),
            Tuple.Create("Mysterious Crystal Scorpion", (ISetPiece) new MysteriousScorpion()),
            Tuple.Create("Defender of the Bee", (ISetPiece) new QueenBee()),
            Tuple.Create("Lost Sentry", (ISetPiece) new LostSentry()),
            Tuple.Create("The Keyper", (ISetPiece) new Keyper()),
            //Tuple.Create("Encounter Altar", (ISetPiece) new GarnetJade()),
            Tuple.Create("Dragon Head", (ISetPiece) new RockDragon()),
            Tuple.Create("Kharanos, the Lost Dragon", (ISetPiece) new ShallowWater())//CultistEvent

        };

        private readonly List<Tuple<string, ISetPiece>> _rareEvents = new List<Tuple<string, ISetPiece>>()
        {
           Tuple.Create("Zhin, The Demonic Sacrifice", (ISetPiece) new CultistEvent())
        };
        ...
        private static readonly Tuple<string, TauntData>[] CriticalEnemies = new Tuple<string, TauntData>[]
        {
            ...
            Tuple.Create("Permafrost Lord", new TauntData()),
            Tuple.Create("Ghostly Sorcerer", new TauntData()),
            Tuple.Create("BB Biff the Buffed Bunny", new TauntData()),
            Tuple.Create("md Janus the Doorwarden", new TauntData()),
            Tuple.Create("Defender of the Bee", new TauntData()),
            Tuple.Create("Mysterious Crystal Scorpion", new TauntData()),
            Tuple.Create("Alien U.F.O", new TauntData()),
            Tuple.Create("Raijin, the Lightning Guardian", new TauntData()),
            Tuple.Create("Belladonna", new TauntData()),
            Tuple.Create("Spectre's Guardian", new TauntData()),
            Tuple.Create("Bloody Tissue", new TauntData()),//Krystaline
            Tuple.Create("Primaeval The Ancient Totem", new TauntData()),
            Tuple.Create("Krystaline", new TauntData()),
            Tuple.Create("King Toadstool", new TauntData()),
            Tuple.Create("The Keyper", new TauntData())
        };
        #endregion
            ...
            new Dictionary<WmapTerrain, Tuple<int, Tuple<string, double>[]>>()
        {
            ...
            { WmapTerrain.Mountains, Tuple.Create(
                100, new []
                {
                    Tuple.Create("Sor Crystal Deposit", 0.03),
                    Tuple.Create("Death God", 0.05),
                    Tuple.Create("White Demon", 0.1),
                    Tuple.Create("Sprite God", 0.09),
                    Tuple.Create("Medusa", 0.1),
                    Tuple.Create("Ent God", 0.07),
                    Tuple.Create("Beholder", 0.05),
                    Tuple.Create("Flying Brain", 0.06),
        ...
        public void OnPlayerEntered(Player player)
        {
            ...
            player.SendInfo("Welcome to Cosmic Realms");
        ...
        {
            _world.Manager.Chat.Announce(message);
        }
        private void SpawnEvent(string name, ISetPiece setpiece)
        {
            ...
            AnnounceMsg($"{name} has been spawned.");
        }
