...
{
    class AlienCores2 : IEquipStatus
    {
        public EquippedStatus Status => EquippedStatus.AlienCores2;
        ...
        public void OnEquip(Player player)
        {
            ...
            if (player.HP >= player.Stats[0])
                ...
                _divider = (player.HP > _stats[0] / 2) ? 0.2f : 0.1f;
        ...
        public void OnTick(Player player, RealmTime time)
        {
            ...
            if (player.HP >= player.Stats[0])
                ...
                divider = (player.HP > _stats[0] / 2) ? 0.2f : 0.1f;
