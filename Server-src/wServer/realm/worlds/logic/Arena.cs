...
namespace wServer.realm.worlds.logic
{
    class Arena : World
    {
        ...
        private readonly string[][] _randomBosses = new string[][]
        {
            ...
            new string[]
            {
                "Archdemon Malphas", "Septavius the Ghost God", "Leviathan",
                "Thessal the Mermaid Goddess", "Crystal Prisoner", "Gigacorn"
            },
            new string[]
            {
                "Thessal the Mermaid Goddess", "Crystal Prisoner", "Tomb Support",
                "Tomb Defender", "Tomb Attacker", "Tidale, The Defender of the Ancients", "Grand Sphinx",
                "Queen of Hearts", "TestChicken 2"
            },
            new string[]
            {
                "Thessal the Mermaid Goddess", "Crystal Prisoner", "Tomb Support",
                "Tomb Defender", "Tomb Attacker", "Tidale, The Defender of the Ancients",
