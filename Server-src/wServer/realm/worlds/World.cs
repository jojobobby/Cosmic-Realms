...
namespace wServer.realm.worlds
{
    public class World
    {
        ...
        public const int DeathArena = 0;
        public const int Spawners = -16;
        ...
        public bool IsNotCombatMapArea => Id == Nexus || Id == Vault || Id == GuildHall || Id == ClothBazaar || Id == NexusExplanation ||
                                            Id == Tinker;
        public bool SafeMapArea => Name == "Nexus" || Name == "Vault" || Name == "GuildHall" || Name == "Marketplace" || Name == "Planet Selector";
        ...
        public virtual int EnterWorld(Entity entity)
        {
            if (entity is Player)
            {
                ...
                entity.ApplyConditionEffect(ConditionEffectIndex.Stunned, 2500);
        ...
        {
            var regions = Map.Regions.Where(_ => _.Value == region);

            if (regions == null && regions.Count() > 1)
                return null;

            var pos = regions.PickRandom().Key;
